...
/** a
 * @brief Experimental wrapper around calculating noc address targeting a bank managed by the allocator (either DRAM or L1) given bank id and address.
 * This allows direct address to be supplied to NoC apis
 *
 * @note This API is experimental and subject to change.
 */
