...
// Should match with sizeof(FabricTelemetry<2>)
...
#define MEM_ERISC_LITE_FABRIC_RESERVED_SIZE (56 * 1024)
...
#define MEM_AERISC_FABRIC_POSTCODES_BASE (MEM_AERISC_FABRIC_TELEMETRY_BASE - MEM_AERISC_FABRIC_POSTCODES_SIZE)
#define MEM_AERISC_FABRIC_SCRATCH_SIZE 28
#define MEM_AERISC_FABRIC_SCRATCH_BASE (MEM_AERISC_FABRIC_POSTCODES_BASE - MEM_AERISC_FABRIC_SCRATCH_SIZE)

#define MEM_AERISC_ROUTING_TABLE_SIZE MEM_ROUTING_TABLE_SIZE
#define MEM_AERISC_ROUTING_TABLE_BASE (MEM_AERISC_FABRIC_SCRATCH_BASE - MEM_AERISC_ROUTING_TABLE_SIZE)
